...
graph TD
    ...
    subgraph VPS ["🖥️ Virtual Private Server (Ubuntu Host)"]
        ...
        subgraph DockerCompose ["🐳 Docker Compose (production_network Bridge)"]
            ...
            Web -->|Read/Write / Port 5432| DB[(🗄️ PostgreSQL Database)]
...
NGINX acts as the entry point (the "front door") for all incoming traffic to the server. 
